...
PS:
Tested on ESPHome 2026.4.0, might be incompatible with older versions (if using older versions, look in the commits and use an older version of the YAML-code)
